YUI.add("moodle-core_outcome-accessiblepanel", function(Y) {
    ...
    AccessiblePanel.NS = "core_outcome_accessiblepanel";
    ...
    AccessiblePanel.ATTRS = {
         ...
         */
        ariaRole: {
            value: "dialog", writeOnce: true, validator: "_validateAriaRole"
        },
    ...
    M.core_outcome.accessiblepanel = AccessiblePanel;
