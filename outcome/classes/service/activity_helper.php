 ...
 * @author    Mark Nielsen
 */
class outcome_service_activity_helper {
    /**
     * @var moodle_database
     */
    protected $db;
     ...
     * @param outcome_service_report_helper $reporthelper
     * @param moodle_database $db
     */
    public function __construct(outcome_factory $factory = null,
                                outcome_service_report_helper $reporthelper = null,
        ...
        if (is_null($reporthelper)) {
            $reporthelper = new outcome_service_report_helper();
        }
        if (is_null($db)) {
            $db = $DB;
        }
