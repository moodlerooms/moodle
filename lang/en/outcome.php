...
$string['movex'] = 'Move {$a}';
$string['move'] = 'Move';
$string['outcomemodified'] = 'The outcomes in this set have been modified, but not saved.  Use the <em>Save changes</em> button to make the changes permanent or use the <em>Cancel</em> button to revert all changes.';
