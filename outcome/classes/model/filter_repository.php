 ...
 * @author    Mark Nielsen
 */
class outcome_model_filter_repository extends outcome_model_abstract_repository {
    protected $model = 'outcome_model_filter';
    protected $table = 'outcome_used_sets';

    /**
     * @param $record
     * @return outcome_model_filter
     */
     ...
     * @return outcome_model_filter|boolean Returns false if
     ...
     *
     * @param int $courseid
     * @param outcome_model_filter[] $models
     ...
     *
     * @param outcome_model_filter $model
     * @return $this
     */
    public function save(outcome_model_filter $model) {
     ...
     * @return $this
     */
    public function remove(outcome_model_filter $model) {
        if (!empty($model->id)) {
