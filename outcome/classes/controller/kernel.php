...
class kernel {
    ...
    public function __construct(router $router,
                                flash_messages $flashmessages = null,
                                core_outcome_renderer $renderer = null) {
        global $PAGE;

        if (is_null($flashmessages)) {
            $flashmessages = new flash_messages('outcome');
        }
        if (is_null($renderer)) {
    ...
    public function resolve_controller_callback($action) {
        /** @var $controller \core_outcome\controller\controller_abstract */
