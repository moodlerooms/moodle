 ...
 * @author    Mark Nielsen
 */
class outcome_service_coverage_helper {
    /**
     * @var moodle_database
     */
    protected $db;
     ...
     * @param outcome_mod_archetype $modarchetype
     * @param moodle_database $db
     */
    public function __construct(outcome_factory $factory = null,
                                outcome_mod_archetype $modarchetype = null,
        ...
        if (is_null($modarchetype)) {
            $modarchetype = new outcome_mod_archetype();
        }
        if (is_null($db)) {
            $db = $DB;
        }
