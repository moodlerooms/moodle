 ...
 * @author    Mark Nielsen
 */
abstract class outcome_import_abstract implements outcome_import_interface {
    /**
     * @var outcome_model_outcome_set
     */
    ...
    /**
     * @param outcome_service_outcome_helper $outcomehelper
     * @param outcome_service_outcome_set_helper $outcomesethelper
     */
    public function __construct(outcome_service_outcome_helper $outcomehelper = null,
                                outcome_service_outcome_set_helper $outcomesethelper = null) {

        if (is_null($outcomehelper)) {
            $outcomehelper = new outcome_service_outcome_helper();
        }
        if (is_null($outcomesethelper)) {
            $outcomesethelper = new outcome_service_outcome_set_helper();
        }
    ...
    public function get_result() {
        if ($this->outcomeset instanceof outcome_model_outcome_set) {
     ...
     * @return outcome_import_abstract
     */
