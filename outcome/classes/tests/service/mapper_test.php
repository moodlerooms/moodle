...
require_once(dirname(dirname(__DIR__)).'/service/mapper.php');
...
class outcome_service_mapper_test extends basic_testcase {
    public function test_get_outcome_set_mappings() {
        ...
        $filtersmock = $this->getMock(
            'outcome_model_filter_repository',
            array('find_by')
        );
        ...
        $service = new outcome_service_mapper(null, $outcomesetsmock, $filtersmock);
    ...
    public function test_save_outcome_set_mappings() {
        ...
        $service = new outcome_service_mapper(null, null, $filtersmock);
