 ...
 * @author    Mark Nielsen
 */
class outcome_controller_import extends outcome_controller_abstract {
    /**
     * @var outcome_service_import_helper
     */
    public $importhelper;
    ...
    public function init($action) {
        ...
        require_once(dirname(__DIR__).'/service/import_helper.php');

        $this->importhelper = new outcome_service_import_helper();
    }
    ...
    public function outcomeset_import_action() {
        ...
        require_once(dirname(__DIR__).'/form/import.php');
        ...
        $mform     = new outcome_form_import($this->new_url(array('action' => 'outcomeset_import')));
        ...
        if ($mform->is_cancelled()) {
            ...
            if ($result instanceof outcome_model_outcome_set) {
