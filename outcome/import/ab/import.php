 ...
 * @author    Mark Nielsen
 */
class outcomeimport_ab_import extends outcome_import_abstract {
    /**
     ...
     *
     * @param outcome_model_outcome $root This is the root outcome
     * @param XMLReader $reader
     * @throws coding_exception
     * @return outcome_model_outcome
     */
    public function process_outcome(outcome_model_outcome $root, XMLReader $reader) {
