YUI.add('moodle-core_outcome-editoutcome', function(Y) {
    var NAME = 'core_outcome_editoutcome',
    ...
    Y.extend(EDITOUTCOME, Y.Widget,
        {
            ...
            /**
             * Create a panel
             * @param srcNode The source node for the panel content
             * @param title The title for the panel
             * @param saveCallback On save, this will be called
             * @returns {Y.Panel}
             * @private
             */
            _create_panel: function(srcNode, title, saveCallback) {
                ...
                panel.get(SRC_NODE).setStyle('display', 'block')
