 ...
 * @author    Mark Nielsen
 */
class outcome_model_attempt_repository extends outcome_model_abstract_repository {
    protected $model = 'outcome_model_attempt';
    protected $table = 'outcome_attempts';

    /**
     * @param int $id The attempt ID
     * @param int $strictness
     * @return outcome_model_attempt|boolean Returns false if
     ...
     * @return $this
     */
    public function save(outcome_model_attempt $model, $duplicatecheck = true) {
     ...
     * @return $this
     */
    public function remove(outcome_model_attempt $model) {
     ...
     *
     * @param $cmid
     * @param outcome_model_area[] $excludedareas
     * @return $this
     */
