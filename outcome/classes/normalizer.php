...
class outcome_normalizer {
     ...
     * @return array
     */
    public function normalize_outcome(outcome_model_outcome $model, $raw = false) {
    ...
    /**
     * @param outcome_model_outcome[] $models
     * @param bool $raw Include raw data, saves space if you don't include.
     * @return array
     */
     ...
     * @return array
     */
    public function normalize_outcome_set(outcome_model_outcome_set $model) {
        $description = format_text($model->description, FORMAT_MOODLE, array('para' => false));
    ...
    /**
     * @param outcome_model_outcome_set[] $models
     * @return array
     */
