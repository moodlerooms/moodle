...
require_once(dirname(dirname(__DIR__)).'/model/filter_repository.php');
...
class outcome_model_filter_repository_test extends advanced_testcase {
    ...
    public function setUp() {
        ...
        $this->_filter = new outcome_model_filter();
        $this->_filter->id = '1';
    ...
    public function test_find() {
        $repo  = new outcome_model_filter_repository();
        $found = $repo->find(1);
    ...
    public function test_sync() {
        ...
        $model               = new outcome_model_filter();
        $model->courseid     = '2';
    ...
    public function test_sync_multi_course() {
        $model1               = new outcome_model_filter();
        $model1->courseid     = '2';
        $model1->outcomesetid = '2';
        $model1->add_filter('10', 'English');

        $model2               = new outcome_model_filter();
        $model2->courseid     = '1';
