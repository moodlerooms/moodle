...
require_once(dirname(dirname(__DIR__)).'/controller/kernel.php');
...
class outcome_controller_kernel_test extends basic_testcase {
    ...
    public function test_resolve_controller_callback() {
        $controller = $this->getMock('outcome_controller_interface', array(
            'init',
            'set_renderer',
            'test_action',
            'set_flashmessages',
        ...
        $router = $this->getMock('outcome_controller_router', array('route_action'));
    ...
    public function test_execute_callback_with_return() {
        ...
        $kernel = new outcome_controller_kernel(new outcome_controller_router());
