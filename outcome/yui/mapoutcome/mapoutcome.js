YUI.add('moodle-core_outcome-mapoutcome', function(Y) {
    var NAME = 'core_outcome_mapoutcome',
    ...
    requires: ['widget', 'handlebars', 'json-parse', 'json-stringify', 'moodle-core_outcome-outcomemodel', 'moodle-core_outcome-outcomepanel', 'moodle-core-notification']
});
